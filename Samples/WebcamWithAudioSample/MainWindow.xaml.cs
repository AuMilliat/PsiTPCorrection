...
namespace Microsoft.Psi.Samples.WebcamWithAudioSample
{
    ...
    public partial class MainWindow
    {
        ...
        private void MainWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            var webcam = new MediaCapture(this.pipeline, 640, 480, 30, true);
            ...
            webcam.Audio.PipeTo(acousticFeatures);
            ...
            var store = PsiStore.Create(pipeline, "WebcamWithAudioSample", "D:\\Stores");
            ...
            // Write incoming  level in the store at 'Energy' track
            store.Write(acousticFeatures.LogEnergy, "Energy");
